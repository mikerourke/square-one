...
const apiPath = path.resolve(process.cwd(), 'internals/api');
const dbFilePath = `${apiPath}/db.json`;
const staticFilePath = `${apiPath}/static.json`;
 ...
 */
const getUpdatedEntity = (users,
  entity,
  nextId) => Object.assign({}, entity, {
  id: nextId,
